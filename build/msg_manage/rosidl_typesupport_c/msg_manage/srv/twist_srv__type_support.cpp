...
static const _TwistSrv_Request_type_support_symbol_names_t _TwistSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_manage, srv, TwistSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_manage, srv, TwistSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, msg_manage, srv, TwistSrv_Request)() {
  return &::msg_manage::srv::rosidl_typesupport_c::TwistSrv_Request_message_type_support_handle;
}
...
static const _TwistSrv_Response_type_support_symbol_names_t _TwistSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_manage, srv, TwistSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_manage, srv, TwistSrv_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_msg_manage
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, msg_manage, srv, TwistSrv_Response)() {
  return &::msg_manage::srv::rosidl_typesupport_c::TwistSrv_Response_message_type_support_handle;
}
...
static const _TwistSrv_type_support_symbol_names_t _TwistSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_manage, srv, TwistSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_manage, srv, TwistSrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, msg_manage, srv, TwistSrv)() {
  return &::msg_manage::srv::rosidl_typesupport_c::TwistSrv_service_type_support_handle;
}
