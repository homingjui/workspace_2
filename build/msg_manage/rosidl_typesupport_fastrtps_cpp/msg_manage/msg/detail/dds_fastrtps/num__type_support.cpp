...
#include "msg_manage/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const msg_manage::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_manage::msg::Num *>(
    untyped_ros_message);
...
{
  return &msg_manage::msg::typesupport_fastrtps_cpp::_Num__handle;
}
