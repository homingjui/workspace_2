...
class slam_navigation_publisher(Node):

    def __init__(self):
        super().__init__('slam_navigation_pub')
    ...
    def controller(self):
        ...
        data.twist.linear.x = 8.7
        data.twist.angular.z = 3.8
...
def main(args=None):
    ...
    slam_navigation = slam_navigation_publisher()
