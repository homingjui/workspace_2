...
#ifndef MSG_MANAGE__SRV__DETAIL__TWIST_SRV__FUNCTIONS_H_
#define MSG_MANAGE__SRV__DETAIL__TWIST_SRV__FUNCTIONS_H_
...
/// Initialize srv/TwistSrv message.
/**
...
/// Create srv/TwistSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msg_manage__srv__TwistSrv_Request__init().
...
/// Destroy srv/TwistSrv message.
/**
 * It calls
 * msg_manage__srv__TwistSrv_Request__fini()
...
/// Initialize array of srv/TwistSrv messages.
/**
...
/// Finalize array of srv/TwistSrv messages.
/**
 * It calls
 * msg_manage__srv__TwistSrv_Request__fini()
...
/// Create array of srv/TwistSrv messages.
/**
 * It allocates the memory for the array and calls
 * msg_manage__srv__TwistSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TwistSrv messages.
/**
 * It calls
 * msg_manage__srv__TwistSrv_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msg_manage__srv__TwistSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_manage
...
/**
 * It calls
 * msg_manage__srv__TwistSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_manage
...
/**
 * It allocates the memory for the array and calls
 * msg_manage__srv__TwistSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_manage
...
/**
 * It calls
 * msg_manage__srv__TwistSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MSG_MANAGE__SRV__DETAIL__TWIST_SRV__FUNCTIONS_H_
