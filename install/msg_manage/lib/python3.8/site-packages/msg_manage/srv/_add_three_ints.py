...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from msg_manage.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from msg_manage.srv._add_three_ints import AddThreeInts_Request as Request
    from msg_manage.srv._add_three_ints import AddThreeInts_Response as Response
