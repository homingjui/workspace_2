...
class slam_navigation_node(Node):
    def __init__(self):
        ...
        self.rout = np.array([[ 1.2, 0.4],
                              [ 4.9, 0.4],
                              [ 6.0,-1.0],
                              [10.6,-1.0],
                              [11.0,-2.5],
                              [14.0,-2.5]],dtype=np.float)
    ...
    def controller(self):
        ...
        print((self.now_dot,go_dot,deg,dist,deg_path))
        ...
        cv2.circle(a_img, drew_car, car_w, 0, -1)
        ...
        if 1 in add_img:
            ...
            for i in drew_scan:
                if i[2]>0:
                    cv2.circle(a_img2, i[:2], int(car_w*1.5), 1, -1)
                else:
